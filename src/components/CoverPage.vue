          ...
          <button class="button-82-pushable" role="button">
            ...
            <span class="button-82-front join text">
              <img
                width="30"
                height="30"
                src="https://img.icons8.com/fluency/48/add-user-group-woman-woman.png"
...
.sparkle {
  ...
  background: white;
  border-radius: 50%;
  box-shadow: 0 0 10px 2px white; /* Added glow effect */
